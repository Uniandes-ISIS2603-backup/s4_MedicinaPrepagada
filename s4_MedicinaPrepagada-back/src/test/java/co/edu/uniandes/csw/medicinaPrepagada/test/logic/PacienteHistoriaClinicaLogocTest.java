...
/**
 *pruebas para la logica paciente historia clinica
 * 
 * @author MIGUELHOYOS
 */
@RunWith(Arquillian.class)
public class PacienteHistoriaClinicaLogocTest {
    ...
    private void insertData(){
        for(int i = 0; i<3 ; i++){
            ...
            List<HistoriaClinicaEntity> historiasClinicas = new ArrayList<>();
            for(int j = 0; j<3; j++){
            ...
            entity.setHistoriasClinicas(historiasClinicas);
            em.persist(entity);
            data.add(entity);
        }
    }
